...
describe('VentasService', () => {
    ...
    describe('createVenta', () => {
        ...
        it('should throw BadRequestException if totalCentavos is negative', async () => {
            await expect(service.createVenta('emp-1', 'suc-1', 'user-1', { ...mockPayload, totalCentavos: -1 }))
        ...
        it('should throw BadRequestException if caja is not open', async () => {
            ...
            await expect(service.createVenta('emp-1', 'suc-1', 'user-1', mockPayload))
                .rejects.toThrow(BadRequestException);
        });
        ...
        it('should create a sale successfully', async () => {
            ...
            const result = await service.createVenta('emp-1', 'suc-1', 'user-1', mockPayload);
