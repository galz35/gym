...
describe('AuthService', () => {
            ...
            providers: [
                ...
                { provide: DatabaseService, useValue: mockDbService },
                {
                    ...
                    useValue: {
                        ...
                        verifyAsync: jest.fn().mockResolvedValue({ sub: 'user-1', tokenVersion: 1 })
                    }
                },
    ...
    describe('validateUser', () => {
        it('should return user info without hash if password matches', async () => {
            const mockUser = { id: 'user-1', email: 'test@gym.com', hash: 'hashed', estado: 'ACTIVO' };
        ...
        it('should return null if password does not match', async () => {
            dbService.sql.mockResolvedValueOnce([{ hash: 'hashed', estado: 'ACTIVO' }]);
    ...
    describe('login', () => {
        ...
        it('should return tokens and user info on success', async () => {
            const mockUser = { id: 'user-1', email: 'x@x.com', hash: 'h', estado: 'ACTIVO', token_version: 1 };
            dbService.sql.mockResolvedValueOnce([mockUser]);
            (bcrypt.compare as jest.Mock).mockResolvedValueOnce(true);
    ...
    describe('refresh', () => {
        it('should throw ForbiddenException if token version mismatch', async () => {
            ...
            dbService.sql.mockResolvedValueOnce([{ id: 'user-1', token_version: 2, estado: 'ACTIVO' }]);
