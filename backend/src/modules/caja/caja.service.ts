...
export class CajaService {
    ...
    async cerrar(id: string, dto: CloseCajaDto) {
        ...
        const montoPagos = pagosAgg && pagosAgg.total ? BigInt(pagosAgg.total) : BigInt(0);
        const montoApertura = caja.monto_apertura_centavos ? BigInt(caja.monto_apertura_centavos) : BigInt(0);
