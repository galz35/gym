...
BEGIN
    ...
    -- Registrar asistencia y capturar ID
    ...
    -- Construir respuesta JSON compatible con Flutter (agrega asistenciaId)
...
sql.unsafe(query).then(() => {
    console.log('Function fn_checkin_express updated successfully V4 (with asistenciaId)');
    process.exit(0);
}).catch(e => {
